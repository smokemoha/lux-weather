document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleLocationError(error) {
        ...
        const weatherTypes = ['rain', 'sunny', 'wind', 'snow', 'fog'];
        ...
        try {
            ...
            if (data) {
                ...
                if (weatherMain.includes('rain') || weatherMain.includes('drizzle')) {
                    lastWeatherType = 'rain';
                } else if (weatherMain.includes('snow')) {
                    lastWeatherType = 'snow';
                } else if (weatherMain.includes('clear')) {
                    lastWeatherType = 'sunny';
                } else if (weatherMain.includes('fog') || weatherMain.includes('mist') || weatherMain.includes('haze')) {
                    lastWeatherType = 'fog';
                } else if (weatherMain.includes('wind') || weatherMain.includes('squall')) {
                    lastWeatherType = 'wind';
                } else if (weatherMain.includes('thunder') || weatherMain.includes('storm')) {
                    lastWeatherType = 'thunder';
                } else {
                    // Default for clouds or other conditions
        ...
        switch (weatherType) {
            case 'rain':
                if (currentSeason === 'autumn') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #614385, #516395)';
                } else if (currentSeason === 'winter') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #0f2027, #203a43)';
                } else if (currentSeason === 'spring') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #3a6186, #89253e)';
                } else {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #1a2a3a, #0a1a2a)';
                }
                createRainAnimation();
                break;
            case 'snow':
                if (currentSeason === 'winter') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #2c3e50, #3498db)';
                } else {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #2c3e50, #1a2a3a)';
                }
                createSnowAnimation();
                break;
            case 'sunny':
                if (currentSeason === 'summer') {
                    ...
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #e96443, #904e95)';
                } else if (currentSeason === 'winter') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #83a4d4, #b6fbff)';
                } else { // spring
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #83a4d4, #b6fbff)';
                }
            ...
            case 'fog':
                if (currentSeason === 'autumn') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #5d4157, #a8caba)';
                } else {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #7f8c8d, #95a5a6)';
                }
                createFogAnimation();
                break;
            case 'wind':
                if (currentSeason === 'autumn') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #603813, #b29f94)';
                } else {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #3498db, #2c3e50)';
                }
                createWindAnimation();
                break;
            case 'thunder':
            ...
            case 'cloudy':
                if (currentSeason === 'spring') {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #3a7bd5, #3a6073)';
                } else {
                    weatherAnimation.style.background = 'linear-gradient(to bottom, #5d6d7e, #34495e)';
                }
    ...
    function addSeasonalElements() {
        ...
        function getRandomSpringColor() {
            const springColors = ['#FF69B4', '#FF1493', '#FFC0CB', '#FFB6C1', '#FF69B4', '#DA70D6', '#BA55D3'];
            return springColors[Math.floor(Math.random() * springColors.length)];
        }
        
        function getRandomSummerColor() {
            const summerColors = ['#FF4500', '#FF8C00', '#FFA500', '#FFD700', '#FFFF00', '#ADFF2F', '#7FFF00'];
            return summerColors[Math.floor(Math.random() * summerColors.length)];
        }
        
        function getRandomAutumnColor() {
            const autumnColors = ['#8B4513', '#A0522D', '#CD853F', '#D2691E', '#B8860B', '#DAA520', '#F4A460'];
        ...
        function createThunderAnimation() {
            ...
            for (let i = 0; i < 2; i++) {
                createLightningBolt(lightningContainer, i);
            }
